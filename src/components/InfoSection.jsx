  ...
  return (
    <section className="py-12 sm:px-8">
      ...
      <div className="flex md:hidden mt-8 justify-between">
        {/* Phone */}
        <div className="h-14 w-14 flex items-center text-white text-3xl justify-center rounded-full bg-app-blue">
          <BiSolidPhoneCall />
        </div>
        {/* WhatsApp */}
        <div className="h-14 w-14 flex items-center justify-center rounded-full  text-white text-3xl bg-app-blue">
          <BiLogoWhatsapp />
        </div>
        {/* Message */}
